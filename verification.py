    ...
    for index, row in emails_dev.iterrows():
        ...
        for classifier in classifiers:
            for datasize in datasizes:
                try:
                    predictions_emails1.append(
                        train_models.classify_email(email_text, classifier, "emails1", datasize)[0])
                    predictions_emails2.append(
                        train_models.classify_email(email_text, classifier, "emails2", datasize)[0])
